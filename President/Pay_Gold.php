...
$q1 = "select count(*) from tbl_maintenance_status MS INNER JOIN tbl_maintenance MN ON MS.mnid = MN.mnid where MS.mid = " . $_SESSION['mid'] . " and MN.year = '" . date('Y') . "' and MS.status = 'Paid'";
...
if ($data1['count(*)'] == '0') {
    ...
    $pdf->Cell(90, 20, ''.$data_member["dis_12"], 0, 1, 'C');
    ...
    $pdf->Ln(5);
    $pdf->Cell(140, 5, '', 0, 0);
    $pdf->Cell(50, 5, 'Society name', 0, 1, 'C');
