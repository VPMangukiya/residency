...
if ($data1['count(*)'] == '0') {
    ...
    $q1 = "select MS.installment,MS.payment_id,MS.datetime,M.mname,MN.dis_6,S.sname from tbl_maintenance_status MS INNER JOIN tbl_maintenance MN ON MS.mnid = MN.mnid INNER JOIN tbl_Member M ON MS.mid = M.mid INNER JOIN tbl_society S ON MN.sid = S.sid WHERE MS.mid = " . $_SESSION['mid']." and  MN.year = '".date('Y')."' and installment = ".$_SESSION['inst'];
    ...
    $pdf->Cell(90, 20, ''.$data_member["dis_6"], 0, 1, 'C');
